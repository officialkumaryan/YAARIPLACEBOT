...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am **YAARI PLACE BOT**  group management bot.
...
TECHNO_IMG = "https://telegra.ph/file/ffe39109fb55eb680f406.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/yaariplacebot")],
                                                                                   [InlineKeyboardButton(text="ADD YAARIPLACE TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/officialkumaryan/YAARIPLACEBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("GROUPS FOR FRIENDSHIP")
